...
public:
    ...
    void setupUi(QWidget *Tab4SensorChart)
    {
        ...
        verticalLayout_3 = new QVBoxLayout(Tab4SensorChart);
        ...
        pPBChartClear = new QPushButton(Tab4SensorChart);
        pPBChartClear->setObjectName("pPBChartClear");

        horizontalLayout->addWidget(pPBChartClear);
    ...
    void retranslateUi(QWidget *Tab4SensorChart)
    {
        ...
        pPBChartClear->setText(QCoreApplication::translate("Tab4SensorChart", "Clear", nullptr));
    } // retranslateUi
